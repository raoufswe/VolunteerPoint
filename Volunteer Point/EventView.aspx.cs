...
public partial class EventView : System.Web.UI.Page
{
    ...
    {
        //if (Session["uType"] == null || !Session["uType"].Equals("admin") || !Session["uType"].Equals("volunteer") || !Session["uType"].Equals("organiser"))
         //   Response.Redirect("index.aspx");
    }
    protected void clickSearch(object sender, EventArgs e)
    {
        SqlDataAdapter da = new SqlDataAdapter("select * from event where lower(eventname) Like '%" + TextBox1.Text + "%'", con);
