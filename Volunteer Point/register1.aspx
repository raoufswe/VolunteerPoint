<%@ Page Title="" Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeFile="register1.aspx.cs" Inherits="register1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container2">
        ...
        <div class="form" >
            <form id="contactform">
                <%-- add validations like required field(for all),maximum length(for all),range(for Bdate), regurlar expression (for name,email), compare(confrim password), validation group, --%>
